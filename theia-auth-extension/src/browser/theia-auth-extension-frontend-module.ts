...
import { TheiaAuthExtensionCommandContribution} from './theia-auth-extension-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(TheiaAuthExtensionCommandContribution).inSingletonScope();
